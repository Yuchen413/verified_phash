...
class NeuralHash_AV(nn.Module):
    onnx_path = '/content/drive/MyDrive/Capstone/Models/NeuralHash/Torch Model/model.onnx'

    def __init__(self, in_ch=3, in_dim=32, tmp_model=onnx_path):
        super(NeuralHash_AV, self).__init__()
        self.layers = []
        ...
        self.output = nn.Sequential(
            nn.AdaptiveAvgPool2d(1),
            Conv2dDynamicSamePadding(
                32, 1280, kernel_size=(1, 1), stride=(1, 1)),
            nn.ReLU(),
