...
class NeuralHash(nn.Module):
    def __init__(self, onnx_model=None, **kwargs):
        super().__init__()
        self.layers = []
...
onnx_model = onnx.load('/home/yuchen/code/verified_phash/Learning-to-Break-Deep-Perceptual-Hashing/models/hash_360.onnx')
# result = onnx.checker.check_model(onnx_model)
# tf_rep = prepare(onnx_model)
# tf_rep.export_graph('/home/yuchen/code/verified_phash/Learning-to-Break-Deep-Perceptual-Hashing/models/tf_model')


# model = "/home/yuchen/code/verified_phash/Learning-to-Break-Deep-Perceptual-Hashing/models/tf_model/saved_model.pb"
# output_path = "/home/yuchen/code/verified_phash/Learning-to-Break-Deep-Perceptual-Hashing/models/new_model.onnx"
...
torch.save(pytorch_model.state_dict(), '/home/yuchen/code/verified_phash/Learning-to-Break-Deep-Perceptual-Hashing/models/hash_360.pth')
