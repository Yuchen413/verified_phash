...
python adv1_collision_attack.py --model=/home/yuchen/code/verified_phash/Fast-Certified-Robust-Training-mj/64_ep1_resv5_l1_aug2_new_collision/ckpt_best.pth --output_folder=collision_test100 --source=/home/yuchen/code/verified_phash/ribosome/coco100x100_val --sample_limit=100 --threads=100 --target_hashset=dataset_hashes/dog_10K_hashes_robust.csv
