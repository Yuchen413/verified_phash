...
def main():
    ...
    opts.model = '/home/yuchen/code/verified_phash/Fast-Certified-Robust-Training/mnist_pdq_ep1_aug2/ckpt_best.pth'
    ...
    get_preimage(modified_model, val_dataloader, use_cuda, eps=opts.epsilon, dummy_input=torch.zeros(1,channel,opts.in_dim,opts.in_dim))
