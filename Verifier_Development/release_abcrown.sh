...
echo 'gonna remove auto_LiRPA'
git rm -rf auto_LiRPA
rm -rf auto_LiRPA
echo 'gonna add submodule'
git submodule add git@github.com:Verified-Intelligence/auto_LiRPA.git
...
echo "Changed files:"
git add .
git commit -m 'October 2023 prerelease'
git push -f
popd
